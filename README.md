...
### Chrome “Local Network Access” during wallet / checkout
...
|---|---|---|---|---|
| `NEXT_PUBLIC_WALLET_CONNECT_PROJECT_ID` | Public | No | Legacy alias for `NEXT_PUBLIC_WALLETCONNECT_PROJECT_ID` (either name works in code) | — |
